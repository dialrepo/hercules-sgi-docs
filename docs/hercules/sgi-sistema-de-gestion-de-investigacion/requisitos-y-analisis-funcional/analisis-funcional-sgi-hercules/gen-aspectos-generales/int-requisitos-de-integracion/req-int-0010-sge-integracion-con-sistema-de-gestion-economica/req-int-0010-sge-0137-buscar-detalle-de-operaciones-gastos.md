# Hércules : REQ\-INT\-0010\-SGE\-0137 \- Buscar detalle de operaciones \- Gastos
...
Consultar el detalle de operaciones contables de gasto asociadas a las aplicaciones presupuestarias del proyecto económico. Toda la información económica del proyecto se presentará agrupada por anualidad (siempre que en el proyecto se hubiera recogido el desglose por anualidad), de forma que  se podrán seleccionar una o varias anualidades para las que recuperar el detalle de las operaciones contables de gasto

El detalle de campos a recoger de cada operación de gasto será común a todos ellos y deberá ser configurado en tiempo de implantación, pues esta información debe ser recuperada desde el SGE por medio de los mecanismos de integración disponibles.
...
Parámetros de salida: listado de operaciones de gastos donde para cada una se muestra la siguiente información
